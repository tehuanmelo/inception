...
touch srcs/.env
echo "DOMAIN_NAME=tde-melo.42.fr" > srcs/.env
echo "CERT_=./requirements/tools/tde-melo.42.fr.crt" >> srcs/.env
echo "KEY_=./requirements/tools/tde-melo.42.fr.key" >> srcs/.env
